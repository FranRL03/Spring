package com.salesinaos.triana.dam.E07crudcompleto.controller;
...
import com.salesinaos.triana.dam.E07crudcompleto.servicios.AlumnoServicio;
...
public class AlumnoController {
	 ...
	 * a métodos de dicho servicio, en este caso, como solo es un envoltorio del repositorio solo serán cruds, 
	...
	/**
	 * Método que gestiona la petición "/" o de listado de alumnos "list", ya que en ambas se mostrará la lista completa de alumnos.
	 ...
	 * no nos "pintaría" la tabla con el nuevo elemento
