package com.salesianostriana.dam.e08listadosbasicos.servicios;
...
public class ProductoService {
	...
	public List<Producto> obtenerProductosAleatorios(int numero) {
		...
		// Los desordenamos con el método barajar
		Collections.shuffle(listaIds);
		// Nos quedamos con los N primeros, con N = número usando stream
